    ...
    return(
        ...
        <div>
            <div className="-mx-6 px-6 py-4">
                <a href="#" title="home">
                    <img src="/logo.png" width="50" alt="tailus logo"/>
            ...
            <ul className="space-y-2 tracking-wide mt-8">
                ...
                <li>
                    <a href="/auth/register" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                        ...
                        <span className="group-hover:text-gray-700">Customer</span>
                    </a>
                </li>
                <li>
                    <a href="#" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                        ...
                        <span className="group-hover:text-gray-700">Outlet</span>
                    </a>
                </li>
                <li>
                    <a href="#" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                ...
                <li>
                    <a href="#" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                        ...
                        <span className="group-hover:text-gray-700">Entry Transaction</span>
                    </a>
                </li>
            </ul>
        </div>
