...
export default function dashboard() {
  ...
  <>
  <Side/>
  <div id="main-content" className="h-full  relative overflow-y-auto lg:ml-64 lg:mr-64">
               <main>
               ...
               <p className="text-center text-sm text-gray-500 my-10">
                  &copy; 2023 <a href="#" className="hover:underline" target="_blank">Relaun</a>. All rights reserved.
               </p>
            </div>
  </>
   )
